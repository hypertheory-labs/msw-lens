import {
  ...
  onUnhandledRequest,
  resolveWebSocketUrl
} from "./chunk-JKCAMQIX.js";
import {
  __privateAdd,
  __privateGet
} from "./chunk-LTJWWCMK.js";
...
// ../../node_modules/msw/node_modules/@mswjs/interceptors/lib/browser/hasConfigurableGlobal-npXitu1-.mjs
...
// ../../node_modules/msw/node_modules/@mswjs/interceptors/lib/browser/interceptors/WebSocket/index.mjs
...
var _RequestController2_instances, handled_get, _a3;
var RequestController = (_a3 = class {
  constructor(request, source) {
    __privateAdd(this, _RequestController2_instances);
    this.request = request;
    this.source = source;
    this.readyState = _a3.PENDING;
  ...
  */
  async passthrough() {
    invariant2.as(InterceptorError, this.readyState === _a3.PENDING, 'Failed to passthrough the "%s %s" request: the request has already been handled', this.request.method, this.request.url);
    this.readyState = _a3.PASSTHROUGH;
  ...
  */
  respondWith(response) {
    invariant2.as(InterceptorError, this.readyState === _a3.PENDING, 'Failed to respond to the "%s %s" request with "%d %s": the request has already been handled (%d)', this.request.method, this.request.url, response.status, response.statusText || "OK", this.readyState);
    this.readyState = _a3.RESPONSE;
    __privateGet(this, _RequestController2_instances, handled_get).resolve();
  ...
  */
  errorWith(reason) {
    invariant2.as(InterceptorError, this.readyState === _a3.PENDING, 'Failed to error the "%s %s" request with "%s": the request has already been handled (%d)', this.request.method, this.request.url, reason?.toString(), this.readyState);
    this.readyState = _a3.ERROR;
    this.source.errorWith(reason);
    __privateGet(this, _RequestController2_instances, handled_get).resolve();
  }
}, _RequestController2_instances = new WeakSet(), handled_get = function() {
  return this.handled;
}, _a3.PENDING = 0, _a3.PASSTHROUGH = 1, _a3.RESPONSE = 2, _a3.ERROR = 3, _a3);
...
var _a4;
var FetchResponse = (_a4 = class extends Response {
  static isConfigurableStatusCode(status) {
    return status >= 200 && status <= 599;
  }
  static isRedirectResponse(status) {
    return _a4.STATUS_CODES_WITH_REDIRECT.includes(status);
  }
  /**
  ...
  */
  static isResponseWithBody(status) {
    return !_a4.STATUS_CODES_WITHOUT_BODY.includes(status);
  }
  ...
  */
  ...
  constructor(body, init = {}) {
    ...
    const safeStatus = _a4.isConfigurableStatusCode(status) ? status : 200;
    const finalBody = _a4.isResponseWithBody(status) ? body : null;
    super(finalBody, {
      status: safeStatus,
    ...
    _a4.setUrl(init.url, this);
  }
}, _a4.STATUS_CODES_WITHOUT_BODY = [
  101,
  103,
  204,
  205,
  304
], _a4.STATUS_CODES_WITH_REDIRECT = [
  301,
  302,
  303,
  307,
...
var kListenerOptions = /* @__PURE__ */ Symbol("kListenerOptions");
var Emitter2 = class {
  #listeners;
  constructor() {
...
var _a5;
var FetchInterceptor = (_a5 = class extends Interceptor2 {
  constructor() {
    super(_a5.symbol);
  }
  checkEnvironment() {
...
}, _a5.symbol = /* @__PURE__ */ Symbol("fetch"), _a5);
...
var _a6;
var XMLHttpRequestInterceptor = (_a6 = class extends Interceptor2 {
  constructor() {
    super(_a6.interceptorSymbol);
  }
  checkEnvironment() {
...
}, _a6.interceptorSymbol = /* @__PURE__ */ Symbol("xhr"), _a6);
